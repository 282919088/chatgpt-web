...
const renderTemplate = () => {
  const [keyLimit, valueLimit] = isMobile.value ? [6, 9] : [15, 100]
...
<template>
  <NMessageProvider>
    <NModal v-model:show="show" style="width: 80%; max-width: 1200px;">
      <NCard>
        <div class="space-y-4">
          <NTabs type="segment">
            <NTabPane name="local" tab="本地管理">
              ...
              <br>
              <NDataTable :columns="columns" :data="renderTemplate()" :pagination="pagination" :bordered="false" />
            </NTabPane>
                        ...
                        <NIcon>
                          ...
                          >
                            <path
                              ...
                              stroke-width="32" d="M256 112v288"
                            />
                            <path
                              fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
    ...
    <NModal v-model:show="showModal">
      <NCard style="width: 600px" :bordered="false" size="huge" role="dialog" aria-modal="true">
        <NSpace v-if="modalMode === 'add' || modalMode === 'modify'" vertical>
          模板标题
          <NInput v-model:value="tempPromptKey" placeholder="模板标题" />
          模板内容
          <NInput v-model:value="tempPromptValue" placeholder="模板内容" type="textarea" />
          <NButton
